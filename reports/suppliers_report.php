...
<div class="official-report-banner">
    <h3>تقرير الموردين وحسابات الإجماليات الشامل (Suppliers Master Report)</h3>
...
<div class="card-flat">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="m-0 font-weight-bold"><i class="bi bi-person-badge ml-2 text-primary"></i>سجل أرصدة الموردين الإجمالي</h5>
        <span class="badge badge-light border px-2 py-1">إجمالي الموردين: <?php echo count($suppliers_list); ?></span>
    </div>
            ...
            <table class="report-table sap-grid-table">
                <thead>
                    <tr>
                        ...
                        <th style="width:13%;">الشركة / المؤسسة</th>
                        <th style="width:11%;">رقم الجوال</th>
                        <th style="width:9%;">عدد الفواتير</th>
                        <th style="width:12%;">إجمالي المشتريات</th>
                        <th style="width:11%;">له علينا (دائن)</th>
                        <th style="width:11%;">عليه لنا (مدين)</th>
                    ...
                    <?php if (!empty($suppliers_list)): ?>
                        ...
                        <tr>
                            ...
                            <td class="text-center no-print">
                                <a href="account_statement.php?type=supplier&account_name=<?php echo urlencode($s['supp_name']); ?>&account_id=<?php echo $s['supp_id']; ?>" class="btn btn-xs btn-primary font-weight-bold" title="عرض كشف حساب المورد التفصيلي المستقل">
                        ...
                        <?php endforeach; ?>
                    <?php else: ?>
                        <tr><td colspan="9" class="text-center py-4 text-muted">لا توجد نتائج مطابقة لخيارات البحث</td></tr>
                    <?php endif; ?>
                </tbody>
            </table>
        </div>
