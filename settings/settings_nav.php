        ...
        <div class="modal-content">
            <form id="form-support-f2">
                <div class="modal-header">
                    <h5 class="modal-title"><i class="bi bi-wrench"></i> فتح وضع الدعم الفني لادارة قاعدة البيانات</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body text-right">
                    <p class="small text-muted">يرجى إدخال الرقم السري المعتمد للدخول لوضع مهندس الدعم (الافتراضي هو 123).</p>
